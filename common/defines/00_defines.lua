...
NDiplomacy = {
	...
	PEACE_SCORE_SCALE_FACTOR = 1.25,                -- Losers' total value times this factor becomes the default total peace conference score that is distributed to the winner
	...
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.00,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
	VOLUNTEERS_RETURN_EQUIPMENT = 0.90,				-- Returning volunteers keep this much equipment
	VOLUNTEERS_TRANSFER_SPEED = 15,					-- days to transfer a unit to another nation
	...
	TENSION_NO_CB_WAR = 10,							-- Amount of tension generated by a no-CB war
	TENSION_CB_WAR = 5,							-- Amount of tension generated by a war with a CB
	TENSION_ANNEX_NO_CLAIM = 1.5,						-- Amount of tension generated by annexing a state you don't have claims on
...
NCountry = {
	...
	REINFORCEMENT_DIVISION_PRIORITY_COUNT = 3, 		-- How many priority stages we have in division template? 0Reserves, 1Normal, 2Elite.
	REINFORCEMENT_DIVISION_PRIORITY_DEFAULT = 1, 	-- Each template by default is 1Normal
	REINFORCEMENT_THEATER_GROUP_PRIORITY_DEFAULT = 1,-- Each theater group by default is 1Normal
	...
	AIR_SCORE_MULTIPLIER = 0.1,							-- Based on number of planes 
	...
	CONVOY_RANGE_FACTOR = 2,                        -- how much range affects convoy need
	...
	WAR_SUPPORT_TENSION_IMPACT = 0.25,				-- Total impact of world tension
	MIN_STABILITY = 0.0,
	MAX_STABILITY = 1.0,
	MIN_WAR_SUPPORT = 0.0,
	MAX_WAR_SUPPORT = 1.0,
	...
	MAJOR_MIN_FACTORIES = 120,						-- need at least these many factories to become a major
	...
	PARADROP_AIR_SUPERIORITY_RATIO = 0.75,			-- Min ratio of air superiority for paradropping
	...
	INTERCEPTION_WAR_SUPPORT_SCALE = 0.00000,		-- Scaling of interceptions to war support impact
    INTERCEPTION_BOMBING_WAR_SUPPORT_IMPACT = 0.0,	-- Max impact of interceptions on the war support
	...
	MAX_BOMBING_WEEKLY_WAR_SUPPORT_PENALTY = -0.01,			-- Max penalty that will gained per week from bomber's damage
	...
	BASE_COMMAND_POWER_GAIN = 0.3,				-- base value for daily command power gain
	ATTACHE_XP_SHARE = 0.1,							-- Country received xp from attaches
	SPECIAL_FORCES_CAP_BASE = 100000,					-- Max ammount of special forces battalions is total number of non-special forces battalions multiplied by this and modified by a country modifier
	SPECIAL_FORCES_CAP_MIN = 1000000,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
	...
	ARMY_COUNT_DAILY_LERP_FOR_TRAINING_XP = 0.0015, -- number of armies that is used in training xp calculates daily lerps to actual number (if real number is lower)
...
NResistance = {
	...
	INITIAL_STATE_COMPLIANCE = 0.1,							-- initial compliance percentage of a state once it is captured
...
NMarket = {
	...
	PURCHASE_CONTRACT_SUBSIDY_BONUS_SPEED_FACTOR = 15.0,				-- The factor of speed bonus from subsidies
...
NIndustrialOrganisation = {
	...
	DESIGN_TEAM_CHANGE_XP_COST = 0,				-- Flat cost added to the XP cost of a new equipment design
...
NProject = {
	...
	DEFAULT_PROJECT_COMPLETION_SCIENTIST_EXPERIENCE_GAIN = 400.0,	-- Default experience gain for assigned scientist when a project is completed
	...
	SCIENTIST_BASIC_RESEARCH_DAILY_XP_GAIN = 0.6,	-- Daily experience gain for doing basic research
	...
	BASIC_RESEARCH_TECHNOLOGY_BONUS_DIMINISHING_RETURN_FACTOR = 0.1, -- Diminishing return on BASIC_RESEARCH_TECHNOLOGY_BONUS_FACTOR for each extra scientist performing basic research for multiple facilities.
	BREAKTHROUGH_DAILY_TECHNOLOGY_GAIN = 8,           -- Amount in 1/100th percentage. E.g. 25 = 0.25%
	BREAKTHROUGH_DAILY_SCIENTIST_SKILL_GAIN = 8,       -- Amount in 1/100th percentage gained per skill when doing basic research. E.g. 5 = 0.05% per skill level.
	...
	BREAKTHROUGH_DAILY_NUCLEAR_REACTOR_GAIN = 20,       -- Amount in 1/100th percentage gained per nuclear reactor. E.g. 2 = 0.02% per nuclear reactor.
...
NProduction = {
	...
	BASE_FACTORY_EFFICIENCY_GAIN = 0.8,		-- Base efficiency gain for factories per unit produced in %. 1.00
	BASE_FACTORY_EFFICIENCY_BALANCE_FACTOR = 0.11, 			-- Factory efficiency balancing factor
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 250000,	-- How many deployment lines minimum can be training
...
NTechnology = {
	...
	MIN_RESEARCH_SPEED = 0.025,				-- research speed can't go below this value
},
...
NMilitary = {
	...
	INFRASTRUCTURE_MOVEMENT_SPEED_IMPACT = -0.031,	-- speed penalty per infrastucture below maximum.
	...
	RECON_SKILL_IMPACT = 8, -- how many skillpoints is a recon advantage worth when picking a tactic.
	...
	PARACHUTE_DISRUPTED_AA_PENALTY = 0.75,            -- How much the Air defence in the state (from AA buildings level * air_defence) is scaled to affect overall disruption (equipment,manpower,str).
	PARACHUTE_COMPLETE_ORG = 0.5,				   -- Organisation value (in %) after unit being dropped, regardless if failed, disrupted, or successful.
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 0.32,	 	       -- % of equipment lost to strength ratio in combat, so some % is returned if below 1
	...
	PLANNING_GAIN = 0.025,
	PLANNING_MAX = 0.15,                           	-- can get more from techs
	...
	ACCLIMATIZATION_SPEED_GAIN = 0.1,				-- A variable used to balance the overall speed of gaining the acclimatization
	...
	FIELD_MARSHAL_XP_RATIO = 0.8,					-- xp gain ratio for army group leaders
	...
	NAVY_LEADER_LEVEL_UP_STAT_COUNT = 3, 				-- num stats gained on level up
	...
	UNIT_LEADER_MODIFIER_COOLDOWN_ON_GROUP_CHANGE = 0,		-- time in days for a unit leader to regain its modifiers
...
NAir = {
	STRATEGIC_BOMBING_PROV_BUILD_PRIO_SCALE = 1.6,					-- Scale of the selected priority for provincial buildings
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.36,					-- Balancing value to convert damage ( nanaval_strike_attackval_strike_attack * hits ) to Strength reduction.
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO_PER_DAY = 0.09, -- max extra plane % that ca n join every day
	...
	EFFICIENCY_REGION_CHANGE_PENALTY_FACTOR = 1,				-- Penalty applied for changing region
	...
	DISRUPTION_FACTOR_CARRIER = 9,							-- multiplier on disruption damage to scale its effects on carrier vs carrier planes	
	...
	CARRIER_PLANES_AMOUNT_FOR_POSITIONING = 40,         -- below this amount of planes on a carrier we no longer get max benefit on enemy positioning 
...
NSupply = {
	...
	CAPITAL_INITIAL_SUPPLY_FLOW = 4, -- starting supply from
	...
	SUPPLY_FLOW_DIST_LOGISTICS_FALLOFF_SCALAR = 0.6, -- Max Penalty adjustment due to distance
...
NNavy = {
	...
	SCREEN_RATIO_FOR_FULL_SCREENING_FOR_CONVOYS 					= 0.35,	-- this screen ratio to num convoys is needed for full screening beyond screen line
	...
	DETECTION_CHANCE_MULT_AIR_SUPERIORITY_BONUS = 0.3,			-- bonus from air superiority.
	...
	REPAIR_AND_RETURN_PRIO_HIGH_COMBAT = 0.6,						-- % of total Strength. When below, navy will go to home base to repair (in combat).
	...
	UNIT_EXPERIENCE_SCALE = 1,
	EXPERIENCE_FACTOR_CONVOY_ATTACK = 0.01,
	EXPERIENCE_FACTOR_NON_CARRIER_GAIN = 0.01,						-- Xp gain by non-carrier ships in the combat
	EXPERIENCE_FACTOR_CARRIER_GAIN = 0.06,							-- Xp gain by carrier ships in the combat
	FIELD_EXPERIENCE_SCALE = 0.06,
	FIELD_EXPERIENCE_MAX_PER_DAY = 30,								-- Most xp you can gain per day
	LEADER_EXPERIENCE_SCALE = 1.0,
	...
	NAVAL_TRANSFER_BASE_NAVAL_DIST_ADD = 101,						-- Extra cost for naval movement ( compared to land movement ) when deciding what ports to use for a naval transfer
	...
	AGGRESSION_HEAVY_GUN_EFFICIENCY_ON_LIGHT_SHIPS = 0.1,-- ratio for scoring for different gun types against light ships
	AGGRESSION_TORPEDO_EFFICIENCY_ON_LIGHT_SHIPS = 2,   -- ratio for scoring for different gun types against light ships
	
	AGGRESSION_LIGHT_GUN_EFFICIENCY_ON_HEAVY_SHIPS = 0.4, -- ratio for scoring for different gun types against heavy ships
	...
	SUPREMACY_PER_SHIP_PER_MANPOWER = 0.2,							-- supremacy of a ship is calculated using its IC, manpower and a base define
	SUPREMACY_PER_SHIP_PER_IC = 0.02,
	SUPREMACY_PER_SHIP_BASE = 35.0,
	...
	NAVAL_MINES_NAVAL_SUPREMACY_FACTOR = 0.75,						-- Factor for max amount of mines increasing naval supremacy
	...
	TRAINING_MAX_DAILY_COUNTRY_EXP = 2,							-- Maximum navy XP daily gain
	...
	BASE_SPOTTING_FROM_AIR_SUPERIORITY = 30,						-- base spotting percentage that comes from air superiority
	...
	SPOTTING_MULTIPLIER_FOR_SURFACE = 0.4,							-- task force surface spotting value is multiplied by this and added to spotting percentage every hour
	...
	BASE_SPOTTING_SPEED = 0.5,										-- daily base spotting speed
	...
	UNIT_TRANSFER_SPOTTING_SPEED_MULT = 50,						-- spotting speed mult against unit transfers
	...
	UNIT_TRANSFER_DETECTION_CHANCE_BASE = 12,							-- unit transfer and naval invasion base chance detection percentage (if this fails, no detection is done on that tick)
	BASE_SPOTTING_EFFECT_FOR_INITIAL_UNIT_TRANSFER_SPOTTING = 3,		-- same as BASE_SPOTTING_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval transfer convoys
	SPOTTING_SPEED_EFFECT_FOR_INITIAL_UNIT_TRANSFER_SPOTTING = 0.15,	-- same as SPOTTING_SPEED_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval transfer convoys
	BASE_SPOTTING_EFFECT_FOR_INITIAL_NAVAL_INVASION_SPOTTING = 6,		-- same as BASE_SPOTTING_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval invasion convoys
	SPOTTING_SPEED_EFFECT_FOR_INITIAL_NAVAL_INVASION_SPOTTING = 0.5,	-- same as SPOTTING_SPEED_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval invasion convoys
	...
	RELATIVE_SURFACE_DETECTION_TO_POSITIONING_FACTOR				= 0.03,	-- multiples the surface detection difference between two sides. the side with higher detection will get a bonus of this value
	MAX_POSITIONING_BONUS_FROM_SURFACE_DETECTION					= 0.18,  -- will clamp the bonus that you get from detection
	
	HIGHER_SHIP_RATIO_POSITIONING_PENALTY_FACTOR					= 0.35, -- if one side has more ships than the other, that side will get this penalty for each +100% ship ratio it has
	MAX_POSITIONING_PENALTY_FROM_HIGHER_SHIP_RATIO					= 0.58,  -- maximum penalty to get from larger fleets

	HIGHER_CARRIER_RATIO_POSITIONING_PENALTY_FACTOR					= 0.0;  -- penalty if other side has stronger carrier air force 
	MAX_CARRIER_RATIO_POSITIONING_PENALTY_FACTOR 					= 0.0;  -- max penalty from stronger carrier air force
	...
	DAMAGE_PENALTY_ON_MINIMUM_POSITIONING 							= 1.1,	-- damage penalty at 0% positioning
	...
	NAVAL_COMBAT_AIR_SUB_DETECTION_FACTOR = 0.05,						-- A global factor that applies after all others, right before the sub detection contributed by plane is added to the global sub detection of a combatant
...
NAITheatre = {
	AI_THEATRE_GENERATION_HOME_THEATRE_DEPTH_RESTRICTION = 2.1,			-- The home theatre is generated based off a initial depth restriction
...
NAI = {
	...
	AIFC_PATH_MAX_COST = 5.0,                                   -- Only allow paths with total cost <= this. WARNING: increasing this value may cause stuttering and other performance issues (since AIFC will evaluate larger areas)
	...
	EQUIPMENT_MARKET_NR_DELIVERIES_SOFT_MAX = 11,                   -- AI tries to adjust assigned factories and amount of equipment to keep nr deliveries at max this
	...
	CONSTRUCTION_PRIO_UNSPECIFIED = 0.51,                                       -- base prio for unspecified buildings (none of the categories above) in the construction queue
	...
	FORT_LEVEL_TO_CONSIDER_HIGHLY_FORTIFIED = 2,	-- Provinces above this level of fortification will be considered highly fortified by plan evaluation
	...
	RESEARCH_NEW_DOCTRINE_RANDOM_FACTOR = 0.05,	-- How much randomness is allowed to contribute to do new research expressed as a factor of total tech weights. Higher means more random exploration.
		...
		AI_UPDATE_ROLES_FREQUENCY_HOURS = 480;               -- Update the roles for a country AI this often (affects performance)
	...
	DIPLOMACY_SEND_MAX_FACTION = 0.0,			-- Country should not send away more units than this as expeditionaries
	DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 50,		-- Base value of volunteer acceptance (help is welcome)
	DIPLOMACY_ACCEPT_ATTACHE_BASE = 100,			-- Base value of attache acceptance (help is welcome)
	...
	PRODUCTION_EQUIPMENT_SURPLUS_FACTOR = 1,	-- Base value for how much of currently used equipment the AI will at least strive to have in stock
	...
	AIR_SUPERIORITY_FACTOR = 3.75,				-- Factor for air superiority score
	...
	DIVISION_UPGRADE_MIN_XP = 1200,				-- Minimum XP before attempting to upgrade a division template.
	DIVISION_CREATE_MIN_XP = 1200,				-- Minimum XP before attempting to create a fresh new division template.
	...
	MINIMUM_EQUIPMENT_TO_ASK_LEND_LEASE = -1999999,	-- AI will accept to lend lease this equipment only if our stockpile is less than that.
	...
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 2, 	-- How willing major powers are to send volunteers.
	...
	MAIN_ENEMY_FRONT_IMPORTANCE = 7.5,			-- How much extra focus the AI should put on who it considers to be its current main enemy.
	EASY_TARGET_FRONT_IMPORTANCE = 7.5,			-- How much extra focus the AI should put on who it considers to be the easiest target.
	AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.1,	-- If less than this fraction of units on a front is moving, AI sees it as ready for action	
	MICRO_POCKET_SIZE = 10,						-- Pockets with a size equal to or lower than this will be mocroed by the AI, for efficiency.
	...
	VP_LEVEL_IMPORTANCE_HIGH = 1,				-- Victory points with values higher than or equal to this are considered to be of high importance.
	...
	ORG_UNIT_WEAK = 0.45,						-- Organization % for unit to be considered weak
	...
	STR_UNIT_NORMAL = 0.5,						-- Strength (equipment) % for unit to be considered normal
	...
	SUPPLY_CRISIS_LIMIT = 1,					-- If a unit is standing in an area with 
	...
	MAX_REQUEST_EXPEDITIONARIES_ARMY_RATIO = 0,				-- AI will not accept expeditionary requests if its expeditions are above this ratio
	CASUALTY_RATIO_TO_PULL_EXPEDITIONARIES_BACK = 0,			-- AI will pull expeditioniries back if its casualties is aboce this ratio compared to their total deployed manpower
	CASUALTY_RATIO_TO_NOT_SEND_EXPEDITIONARIES = 0,			-- AI will not send expeditioniries if its casualties is aboce this ratio compared to their total deployed manpower
	
	SURRENDER_LEVEL_TO_PULL_EXPEDITIONARIES_BACK = 0.0,			-- AI will pull expeditioniries back if its surrender level is above this ratio
	SURRENDER_LEVEL_TO_NOT_SEND_EXPEDITIONARIES = 0.0,			-- AI will not send expeditioniries if its surrender level is above this ratio
	...
	MANPOWER_FREE_USAGE_THRESHOLD = 100000,				-- If AI has this much manpower he doesn't care about the percentage
	...
	STOP_TRAINING_EQUIPMENT_LEVEL = 0.6,                -- ai will not train if equipment drops below this level
	BUILD_REFINERY_LACK_OF_RESOURCE_MODIFIER = 0.01,	-- How much lack of resources are worth when evaluating what to build.
	...
	NAVY_PREFERED_MAX_SIZE = 80,						-- AI will generally attempt to merge fleets into this size, but as a soft limit.
	...
	TRANSPORTS_PER_PARATROOPER = 10,					-- Air transports only duty is to drop paratroopers.
	...
	MAX_UNITS_FACTOR_AREA_ORDER = 1.5,					-- Factor for max number of units to assign to area defense orders
	DESIRED_UNITS_FACTOR_AREA_ORDER = 1.5,				-- Factor for desired number of units to assign to area defense orders
	MIN_UNITS_FACTOR_AREA_ORDER = 1.5,					-- Factor for min number of units to assign to area defense orders
	...
	MINES_PLANTING_DESIRE_PER_HOME_STATE = 0,			-- Scoring for how much do we want to plant naval mines with our air wings if the naval region is adjacent to a home state. Multiple adjacent states increases the score. Max sum of score is 1.0.
	MINES_PLANTING_DESIRE_PER_ENEMY_STATE = 0,		-- Scoring for how much do we want to plant naval mines with our air wings if the naval region is adjacent to the enemy state. Multiple adjacent states increases the score. Max sum of score is 1.0.
	MINES_PLANTING_DESIRE_PER_NAVAL_THREAT = 0,		-- How much threat must be generated in the naval region, in order to get the maximum desire to plant naval mines in there.
	...
	LAND_COMBAT_IMPORTANCE_SCALE = 1.8,					-- Lend combat total importance scale (every land combat score get's multiplied by it)
	
	LAND_COMBAT_FIGHTERS_PER_PLANE = 1.5,				-- Amount of air superiority planes requested per enemy plane
	...
	UPGRADES_DEFICIT_LIMIT_DAYS = 100,                           -- Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need
	...
	PORT_STRIKE_HISTORY_VALUE_TO_DISABLE_REPAIRS = 50,		-- cut off for disabling ports above this threshold
...
NOperatives = {
	...
	BUILD_INTEL_NETWORK_DAILY_XP_GAIN = 1.65,
	...
	COUNTER_INTELLIGENCE_DAILY_XP_GAIN = 0.55,
	...
	ROOT_OUT_RESISTANCE_DAILY_XP_GAIN = 0.621,
...
NIntel = {
	...
	DYNAMIC_INTEL_SOURCE_LAND_COMBAT_AGGREGAT_LOG_FACTOR = 0.35,
	DYNAMIC_INTEL_SOURCE_LAND_COMBAT_AGGREGAT_DIVISOR = 15,
	DYNAMIC_INTEL_SOURCE_LAND_COMBAT_MAXIMUMS = { 0, 40, 10, 15 },
	DYNAMIC_INTEL_SOURCE_LAND_COMBAT_ABSOLUTE_MAXIMUMS = { 0, 50, 15, 20 },
	...
	DYNAMIC_INTEL_SOURCE_NAVAL_COMBAT_AGGREGAT_LOG_FACTOR = 0.04,
	DYNAMIC_INTEL_SOURCE_NAVAL_COMBAT_AGGREGAT_DIVISOR = 220,
	DYNAMIC_INTEL_SOURCE_NAVAL_COMBAT_MAXIMUMS = { 15, 0, 50, 30 },
	DYNAMIC_INTEL_SOURCE_NAVAL_COMBAT_ABSOLUTE_MAXIMUMS = { 20, 0, 55, 35 },

	-- Dynamic pool AIR_COMBAT
	DYNAMIC_INTEL_SOURCE_AIR_COMBAT_FLAT_DECAY = 0.0,
	DYNAMIC_INTEL_SOURCE_AIR_COMBAT_MULT_DECAY = 0.985,
	DYNAMIC_INTEL_SOURCE_AIR_COMBAT_AGGREGAT_LOG_FACTOR = 1.5,
	DYNAMIC_INTEL_SOURCE_AIR_COMBAT_AGGREGAT_DIVISOR = 3,
	DYNAMIC_INTEL_SOURCE_AIR_COMBAT_MAXIMUMS = { 0, 0, 0, 30 },
	DYNAMIC_INTEL_SOURCE_AIR_COMBAT_ABSOLUTE_MAXIMUMS = { 0, 0, 0, 35 },
	...
	DYNAMIC_INTEL_SOURCE_AIR_RECON_AGGREGAT_DIVISOR = 220,
	DYNAMIC_INTEL_SOURCE_AIR_RECON_MAXIMUMS = { 30, 25, 35, 25 },
	DYNAMIC_INTEL_SOURCE_AIR_RECON_ABSOLUTE_MAXIMUMS = { 35, 30, 40, 30 },
	...
	LAND_COMBAT_ARMY_INTEL_OVER_OPPONENT_PER_RESERVE_DIVISIONS = 0.2,		-- same for divisions in reserve
	LAND_COMBAT_ARMY_INTEL_OVER_OPPONENT_PER_RETREATING_DIVISIONS = 0.3,		-- same for retreating divisions
	LAND_COMBAT_ARMY_INTEL_FACTOR = 0.03,						-- factor applied once all values have been added together
	...
	LAND_COMBAT_AIR_INTEL_FACTOR = 0.02,						-- factor applied once all values have been added together
	RECON_INTEL_BONUS = 0.1,                                      -- each recon gives this bonus to overall gathered land intel in combat
	...
	AIR_MIN_INTEL_TO_SHOW_AIRWING_CLASSES = 0.5,
